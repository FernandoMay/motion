...
class Email {
  ...
  bool operator ==(Object other) {
    ...
    return other is Email &&
        ...
        other.containsPictures == containsPictures;
  }

  @override
  int get hashCode {
    return Object.hash(sender, time, subject, message, avatar, recipients,
        containsPictures);
  }
}
...
class EmailStore with ChangeNotifier {
  ...
  Email starEmail(String category, int id) {
    final email = _categories[category]!.elementAt(id);
